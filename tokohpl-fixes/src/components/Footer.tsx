      ...
      <div className="shell pt-14 pb-12 grid gap-10 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="text-[13px] leading-7 text-hpl-400 max-w-xs">
            Toko online HPL terpercaya di Indonesia. Menjual EDL HPL dan Lamitak HPL dengan harga terbaik dan pengiriman gratis ke Jawa & Bali.
          </p>
        </div>
        ...
        <div>
          ...
          <address className="not-italic space-y-3">
            ...
            <p className="text-[13px] text-hpl-400">
              <span className="block text-hpl-500 text-[10px] tracking-[0.16em] uppercase mb-1">Pengiriman</span>
              Gratis ke Jawa & Bali
            </p>
          </address>
        </div>
