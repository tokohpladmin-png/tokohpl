        ...
        <div className="space-y-0 border border-hpl-line divide-y divide-hpl-line">
          ...
          <div className="p-8">
            ...
            <div className="grid sm:grid-cols-3 gap-px bg-hpl-line border border-hpl-line">
              <div className="bg-white p-5">
                <p className="text-[10px] font-semibold tracking-[0.18em] uppercase text-hpl-500 mb-2">Ongkos Kirim</p>
              ...
              <div className="bg-white p-5">
                ...
                <p className="text-[15px] font-bold text-hpl-ink">Tergantung lokasi tujuan</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 bg-hpl-50">
            ...
            <ul className="space-y-2">
              {[
                'Ongkos kirim dihitung berdasarkan berat dan tujuan pengiriman.',
