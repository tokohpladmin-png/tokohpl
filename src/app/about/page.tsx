    ...
    <div>
      <div className="border-b border-hpl-line bg-hpl-50">
        <div className="shell py-12">
          ...
          <h1 className="display text-hpl-ink text-4xl sm:text-5xl">Tentang TokoHPL</h1>
        </div>
      </div>
      ...
      <div className="shell py-14 sm:py-20 max-w-3xl">
        ...
        <div className="grid sm:grid-cols-2 gap-px bg-hpl-line border border-hpl-line mb-12">
          {[
            ...
            },
            {
              ...
              body: 'Pengiriman gratis ke seluruh wilayah Jawa dan Bali. Untuk wilayah lain, tersedia layanan pengiriman dengan tarif kompetitif.',
            },
          ].map((item) => (
        ...
        <p className="text-[14px] leading-7 text-hpl-600">
          Untuk konsultasi produk dan informasi lebih lanjut, silakan menghubungi kami melalui WhatsApp atau surel yang tersedia di halaman Kontak.
        </p>
      </div>
    </div>
  );
