      ...
      <section className="relative isolate overflow-hidden bg-hpl-ink min-h-[calc(100vh-100px)] flex items-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 border-t border-white/10">
          <div className="shell py-4 flex items-center gap-8 overflow-x-auto">
            {['Distributor Resmi EDL HPL', 'Distributor Resmi Lamitak HPL', 'Gratis Ongkir Jawa & Bali', 'Harga Kompetitif'].map((item) => (
      ...
      <section className="border-b border-hpl-line">
        <div className="shell py-14 sm:py-20">
          <div className="flex items-end justify-between mb-10">
            <div>
              <p className="label mb-3">Koleksi Kami</p>
              <h2 className="display text-hpl-ink text-4xl sm:text-5xl">Dua Brand Terpercaya</h2>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-hpl-line border border-hpl-line">
            {[
              ...
              <Link key={item.href} href={item.href}
                ...
                <p className="mt-4 text-[11px] font-semibold tracking-[0.16em] uppercase text-hpl-gold">Lihat Produk →</p>
              </Link>
            ))}
          </div>
        </div>
