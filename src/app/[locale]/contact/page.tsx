      ...
      <div className="shell py-14 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-14">
            ...
            <div className="border border-hpl-line divide-y divide-hpl-line">
              <div className="px-6 py-5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-hpl-500 mb-0.5">{t('whatsapp')}</p>
              ...
              <div className="px-6 py-5 flex items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-hpl-500 mb-0.5">{t('email')}</p>
              ...
              <div className="px-6 py-5 flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-hpl-500 mb-0.5">{t('hours')}</p>
                  <p className="text-[14px] font-medium text-hpl-ink">{t('hoursValue')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="border border-hpl-line p-8">
            <p className="label mb-6">{t('companyLabel')}</p>
            <p className="text-[14px] font-bold text-hpl-ink mb-5">{t('companyName')}</p>
            <div className="flex items-start gap-4 mb-6">
              ...
              <address className="not-italic text-[13px] leading-7 text-hpl-600">
                ...
                {t('addressLine2')}<br />
                {t('addressLine3')}<br />
                {t('phonePrefix')} <a href="tel:+62811945224" className="hover:text-hpl-accent transition-colors">0811 945 224</a>
              </address>
            </div>
          </div>
