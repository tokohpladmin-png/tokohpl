...
export function OrderConfirmationClient() {
  ...
  if (!mounted || !order) return (
    <div className="shell py-20 text-center">
      <p className="text-hpl-500 text-[13px]">Memuat pesanan...</p>
    </div>
  );

  const { id, customer, items, subtotal, discountAmount, grandTotal, shippingFee, orderTotal, couponCode } = order;
            ...
            <div className="border border-hpl-line">
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex justify-between text-[13px]">
                  ...
                  <span className="font-semibold text-hpl-ink">{formatIDR(shippingFee)}</span>
                </div>
